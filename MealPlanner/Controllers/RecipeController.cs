...
namespace MealPlanner.Controllers
{
    public class RecipeController : Controller
    {
        public IActionResult Index()
        {
            ...
            recipes.Add(new Recipe(3, "Крамбл с яблоками и корицей",
            ...
            recipes.Add(new Recipe(4, "Тайский салат с говядиной",
