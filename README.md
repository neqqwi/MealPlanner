...
- [ ] **Ingredient Dictionary:** Centralized database of products with strict units (g, ml, pcs) to prevent typos and ensure accurate calculations.
...
Instructions on how to run the project locally will be added here.
